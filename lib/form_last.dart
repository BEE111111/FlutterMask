...
double calculateBalls(double index, String language, String type, String note, String number_of_authors, String isbn, String pages) {
  double balls = 0;
  if (type.isNotEmpty) {
    if (type == 'journal') {
      if (index != 0 ) {
...
class BibEntryEditPage1 extends StatefulWidget {
  ...
  const BibEntryEditPage1({Key? key, required this.entryId, required this.id_,  required this.username}) : super(key: key);
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () async {
                            if (_formKey.currentState!.validate()) {
                              ...
                              _currentEntry.index = double.tryParse(_indexController.text) ?? 0;
                              ...
                              double p = calculateBalls(_currentEntry.index, _currentEntry.language, _currentEntry.type, _currentEntry.note, _currentEntry.number_of_authors, _currentEntry.isbn, _currentEntry.pages);
...
void main() {
  runApp(MaterialApp(home: BibEntryEditPage1(entryId: 'some_entry_id', id_: 'some_id', username: username,))); // Use actual entryId and id_
}
