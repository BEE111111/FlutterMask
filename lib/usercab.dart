...
class Work {
  ...
  Work({required this.id, required this.title, required this.checked, required this.ball});
...
class _CountPageState extends State<CountPagef> {
  ...
  void initState() {
    super.initState();
    futureCheckedWorks = fetchWorks('http://127.0.0.1:8000/bibtex/checked/${username}/');
    futureUncheckedWorks = fetchWorks('http://127.0.0.1:8000/bibtex/unchecked/${username}/');
                        ...
                        children: [
                          ...
                          if (scientist != null)
                            Column(crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                if (scientist!.author_in_russian.isNotEmpty)
                                  Container(
                                    child: Text(
                                ...
                                if (scientist!.science_title.isNotEmpty)
                                  Container(
                                    child: Row(children: [
                                    Text(
